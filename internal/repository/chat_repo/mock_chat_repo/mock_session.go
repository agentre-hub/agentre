...
// CountIndex mocks base method.
func (m *MockSessionRepo) CountIndex(ctx context.Context, filter chat_repo.SessionIndexFilter) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountIndex", ctx, filter)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CountIndex indicates an expected call of CountIndex.
func (mr *MockSessionRepoMockRecorder) CountIndex(ctx, filter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountIndex", reflect.TypeOf((*MockSessionRepo)(nil).CountIndex), ctx, filter)
}
...
// FindByConversationID mocks base method.
func (m *MockSessionRepo) FindByConversationID(ctx context.Context, conversationID string) (*chat_entity.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindByConversationID", ctx, conversationID)
	ret0, _ := ret[0].(*chat_entity.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FindByConversationID indicates an expected call of FindByConversationID.
func (mr *MockSessionRepoMockRecorder) FindByConversationID(ctx, conversationID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// ListForRollup mocks base method.
func (m *MockSessionRepo) ListForRollup(ctx context.Context, createdFromMs int64) ([]*chat_entity.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListForRollup", ctx, createdFromMs)
	ret0, _ := ret[0].([]*chat_entity.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListForRollup indicates an expected call of ListForRollup.
func (mr *MockSessionRepoMockRecorder) ListForRollup(ctx, createdFromMs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListForRollup", reflect.TypeOf((*MockSessionRepo)(nil).ListForRollup), ctx, createdFromMs)
}
...
// ListIndexPaged mocks base method.
func (m *MockSessionRepo) ListIndexPaged(ctx context.Context, filter chat_repo.SessionIndexFilter, offset, limit int) ([]*chat_entity.Session, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListIndexPaged", ctx, filter, offset, limit)
	ret0, _ := ret[0].([]*chat_entity.Session)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListIndexPaged indicates an expected call of ListIndexPaged.
...
// ResetActiveSessionsByIDs mocks base method.
func (m *MockSessionRepo) ResetActiveSessionsByIDs(ctx context.Context, ids []int64) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ResetActiveSessionsByIDs", ctx, ids)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ResetActiveSessionsByIDs indicates an expected call of ResetActiveSessionsByIDs.
func (mr *MockSessionRepoMockRecorder) ResetActiveSessionsByIDs(ctx, ids any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResetActiveSessionsByIDs", reflect.TypeOf((*MockSessionRepo)(nil).ResetActiveSessionsByIDs), ctx, ids)
}
...
func (mr *MockSessionRepoMockRecorder) UpdateEventCursor(ctx, sessionID, daemonFingerprint, seq any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateEventCursor", reflect.TypeOf((*MockSessionRepo)(nil).UpdateEventCursor), ctx, sessionID, daemonFingerprint, seq)
}
