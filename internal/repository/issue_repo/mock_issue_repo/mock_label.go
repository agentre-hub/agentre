...
// ListRowsByLabel mocks base method.
func (m *MockIssueLabelRepo) ListRowsByLabel(ctx context.Context, labelID int64) ([]*issue_entity.IssueLabel, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListRowsByLabel", ctx, labelID)
	ret0, _ := ret[0].([]*issue_entity.IssueLabel)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListRowsByLabel indicates an expected call of ListRowsByLabel.
func (mr *MockIssueLabelRepoMockRecorder) ListRowsByLabel(ctx, labelID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListRowsByLabel", reflect.TypeOf((*MockIssueLabelRepo)(nil).ListRowsByLabel), ctx, labelID)
}
