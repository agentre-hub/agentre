...
type inboundSessionAdapter interface {
	ListPeerSessions(ctx context.Context, params wire.SessionListParams) (*wire.SessionListResult, error)
	CountPeerSessions(ctx context.Context) (*wire.SessionCountsResult, error)
