...
func authorizePeer(t *testing.T, ws *websocket.Conn, id string) {
	...
	authenticated := relayRequest(t, ws, "desktop-peer", rpc.Frame{
		JSONRPC: "2.0", ID: json.RawMessage(id), Method: "auth.account",
...
func TestInbound_GivenAuthorizedPeer_WhenSettingLocalPath_ThenWritesLocallyAndReportsAtOnce(t *testing.T) {
	...
	unauthenticated := relayRequest(t, ws, "desktop-peer", rpc.Frame{
		JSONRPC: "2.0", ID: json.RawMessage(`1`), Method: wire.MethodProjectSetLocalPath,
	...
	set := relayRequest(t, ws, "desktop-peer", rpc.Frame{
		JSONRPC: "2.0", ID: json.RawMessage(`3`), Method: wire.MethodProjectSetLocalPath,
		Params: mustJSON(t, wire.ProjectSetLocalPathParams{ProjectSyncID: "proj-a", Path: dir}),
	})
...
func TestInbound_GivenProjectNotSyncedHere_WhenSettingLocalPath_ThenTellsThemApart(t *testing.T) {
	...
	res := relayRequest(t, ws, "desktop-peer", rpc.Frame{
		JSONRPC: "2.0", ID: json.RawMessage(`2`), Method: wire.MethodProjectSetLocalPath,
		Params: mustJSON(t, wire.ProjectSetLocalPathParams{ProjectSyncID: "not-here", Path: t.TempDir()}),
	})
	require.NotNil(t, res.Error)
	assert.Equal(t, wire.ErrCodeProjectNotSynced, res.Error.Code)
...
func TestInbound_GivenNonexistentPath_WhenSettingLocalPath_ThenReportsPathNotFound(t *testing.T) {
	...
	require.NotNil(t, res.Error)
	assert.Equal(t, wire.ErrCodeProjectPathNotFound, res.Error.Code)
}
...
func TestInbound_GivenAuthorizedPeer_WhenClearingLocalPath_ThenMarksMissingAndReports(t *testing.T) {
	...
	unauthenticated := relayRequest(t, ws, "desktop-peer", rpc.Frame{
		JSONRPC: "2.0", ID: json.RawMessage(`1`), Method: wire.MethodProjectClearLocalPath,
	...
	cleared := relayRequest(t, ws, "desktop-peer", rpc.Frame{
		JSONRPC: "2.0", ID: json.RawMessage(`3`), Method: wire.MethodProjectClearLocalPath,
		Params: mustJSON(t, wire.ProjectClearLocalPathParams{ProjectSyncID: "proj-a"}),
	})
...
func TestInbound_GivenMissingParams_WhenCallingProjectMethods_ThenRejects(t *testing.T) {
	...
	for i, method := range []string{wire.MethodProjectSetLocalPath, wire.MethodProjectClearLocalPath} {
		res := relayRequest(t, ws, "desktop-peer", rpc.Frame{
			JSONRPC: "2.0", ID: json.RawMessage(json.RawMessage{byte('0' + byte(i) + 2)}), Method: method,
		})
		require.NotNil(t, res.Error, method)
		assert.Equal(t, rpc.ErrInvalidParams.Code, res.Error.Code, method)
	}
}
...
func TestInbound_GivenAuthorizedPeer_WhenBrowsingDirectories_ThenAnswersLikeAgentred(t *testing.T) {
	...
	unauthenticated := relayRequest(t, ws, "desktop-peer", rpc.Frame{
		JSONRPC: "2.0", ID: json.RawMessage(`1`), Method: remotefswire.MethodListDir,
	...
	listed := relayRequest(t, ws, "desktop-peer", rpc.Frame{
		JSONRPC: "2.0", ID: json.RawMessage(`3`), Method: remotefswire.MethodListDir,
		Params: mustJSON(t, remotefswire.ListDirReq{Path: dir}),
	})
	...
	made := relayRequest(t, ws, "desktop-peer", rpc.Frame{
		JSONRPC: "2.0", ID: json.RawMessage(`4`), Method: remotefswire.MethodMkdir,
	...
	again := relayRequest(t, ws, "desktop-peer", rpc.Frame{
		JSONRPC: "2.0", ID: json.RawMessage(`5`), Method: remotefswire.MethodMkdir,
		Params: mustJSON(t, remotefswire.MkdirReq{Parent: dir, Name: "fresh"}),
	})
	require.NotNil(t, again.Error)
	assert.Equal(t, remotefswire.ErrCodeMkdirExists, again.Error.Code)
}
