...
func execDeviceID(ctx context.Context, be *agent_backend_entity.AgentBackend) devicefp.Carrier {
...
func (s *execTargetSvc) resolveExecTarget(ctx context.Context, sess *chat_entity.Session) (*LocalCommandScope, error) {
...
func (s *execTargetSvc) ResolveLocalCommandScope(ctx context.Context, req *ResolveLocalCommandScopeRequest) (*LocalCommandScope, error) {
