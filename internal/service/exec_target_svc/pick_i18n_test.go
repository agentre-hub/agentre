...
// internal/pkg/code 的两份语言包，而不是在 exec_target_svc 里手写中文字面量。判据是
...
func pickAllUnavailable(t *testing.T, lang string) (*exec_target_svc.ExecTargetNoneAvailableError, string, context.Context) {
	t.Helper()
