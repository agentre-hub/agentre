...
var enUS = map[int]string{
	...
	LLMProviderDisabled:             "LLM provider is disabled",
	LLMProviderNoEnabledDefault:     "Set an enabled default model before enabling this provider",
	LLMProviderReferenced:           "This provider is referenced by backends / sessions / routes; deleting it requires explicit confirmation",
	LLMProviderModelNotFound:        "Model not found",
	LLMProviderModelNotOwned:        "This model does not belong to this provider",
	LLMProviderModelDisabled:        "This model is disabled",
	LLMProviderModelIsDefault:       "The default model cannot be disabled or deleted; set another default first",
	LLMProviderModelReferenced:      "This model is referenced by backends / sessions / routes; deleting it requires explicit confirmation",
	...
	HermesLoginRequired:       "This Hermes server requires signing in; enter a username and password",
	HermesLoginExpired:        "Your Hermes session expired; please sign in again",
	HermesLoginRejected:       "Incorrect username or password",
	HermesRateLimited:         "Too many sign-in attempts; please try again later",
	HermesProviderUnsupported: "This provider requires browser authorization, which is not supported yet",
	HermesProviderUnavailable: "The identity provider is temporarily unavailable; try again later",
	...
	ChatBackendRemoteHermesUnavailable: "This Hermes backend is bound to a remote device, but Hermes cannot be dispatched to agentred. Point it at a Hermes server running on this computer.",
	...
	ChatExecTargetOverrideUnavailable:  "This execution target is not available right now, so it cannot be selected",
	ChatExecTargetOverrideNotInList:    "The specified execution target is not in this agent's execution target list",

	ChatExecTargetLineFormat:             "%d. backend #%d (%s): %s",
	ChatExecTargetDeviceLocal:            "this computer",
	ChatExecTargetDeviceRemote:           "device %s",
	...
	ChatBackendHintProviderTypeMismatch:  "Please pick an LLM provider whose type matches this Agent backend in Settings → LLM providers",
	ChatBackendHintRemoteProviderMissing: "The remote agentred has no such provider configured. Add it with its API key on the Remote devices page.",
	ChatBackendHintGatewayNotRunning:     "The local gateway is not running, so CLI backends are unavailable",
	ChatBackendHintRemoteOpenClaw:        "Remote OpenClaw is unavailable: agentred has no secure secret enrollment/reference yet",
	ChatBackendHintUnknownType:           "Unknown Agent backend type",
	ChatAgentNoBackendHint:               "This agent has no backend configured yet. Pick an Agent backend on the org chart page.",
	ChatSystemAgentNoBackendHint:         "The CEO assistant has no backend configured yet. Pick an Agent backend on the org chart page.",
	ChatBackendHintRemoteHermes:          "Remote Hermes is unavailable: Hermes backends run on an Agentre desktop, not on agentred",
	...
	IssueLabelNameDuplicated: "A label with this name already exists",
	...
	RemoteDeviceProtocolUnsupported:     "agentred on that machine does not speak this desktop's protocol. Redeploy agentred there at the same release as this desktop, then try again.",
	RemoteDeviceProtocolVersionMismatch: "agentred on that machine speaks a different protocol version than this desktop. Redeploy agentred there at the same release as this desktop, then try again.",
	...
	ChatImportBackendMismatch:        "The selected Agent's backend differs from this session's backend; pick an Agent on the same backend",
	ChatImportTranscriptOpenFailed:   "Cannot open this session's transcript: the file may have been deleted or is corrupted",
	ChatImportTranscriptReplayFailed: "Failed while reading this session's transcript",
	ChatImportTranscriptEmpty:        "No conversation turn could be read from this transcript",
	ChatImportAgentNoBackend:         "This Agent has no backend configured yet",
	ChatImportGapThinking:            "The thinking content is stored encrypted on disk, so thinking blocks are empty after import; text, tool calls and results are complete.",
	ChatImportGapSubagentInternals:   "The subagent's internal steps were not kept on disk; only its result was imported.",
	ChatImportGapTruncated:           "Part of this session was already truncated on disk; only the remaining content was imported.",
