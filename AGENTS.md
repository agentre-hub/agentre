...
- [docs/architecture.md](docs/architecture.md) — repository layout, cago layering conventions (entity / repo / service / wails binding), shared frontend host-seam patterns, remote-execution architecture, storage paths and environment overrides, database/migration flow, the device-fingerprint column vocabulary, and generated files.
