...
| `preview-canvas` | `#ffffff` | `#ffffff` | Canvas under a rendered HTML page in the file preview. White in both themes because pages are written against the browser's white default |
