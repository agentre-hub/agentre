...
func setValidRunnerIdentity(t *testing.T) {
	...
	t.Setenv(remoteDaemonFPEnv, string(daemonidentity.DaemonFingerprint("test-daemon-instance")))
...
func TestFromPreflightGivenRunnerIdentityReturnsLoggedInLoopbackConfig(t *testing.T) {
	...
	if got.Remote.URL != "ws://127.0.0.1:43211/rpc" ||
		got.Remote.DaemonFingerprint != string(daemonidentity.DaemonFingerprint("test-daemon-instance")) ||
