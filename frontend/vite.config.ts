...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      // 这里显式列出只是为了把前缀匹配挡在门外。
      "@agentre-hub/agentre-ui/tokens.css": fileURLToPath(
        new URL("./packages/agentre-ui/styles/tokens.css", import.meta.url),
      ),
      "@agentre-hub/agentre-ui/code-highlight.css": fileURLToPath(
        new URL(
          "./packages/agentre-ui/styles/code-highlight.css",
          import.meta.url,
        ),
      ),
      "@agentre-hub/agentre-ui/base.css": fileURLToPath(
        new URL("./packages/agentre-ui/styles/base.css", import.meta.url),
      ),
      "@agentre-hub/agentre-ui/toast.css": fileURLToPath(
      ...
      "@agentre-hub/agentre-ui/i18n": fileURLToPath(
      ...
      "@agentre-hub/agentre-ui": fileURLToPath(
