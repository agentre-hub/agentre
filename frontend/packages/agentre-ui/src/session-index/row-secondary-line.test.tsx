...
describe("RowSecondaryLine", () => {
  ...
  it("Agent 头像用宿主那一枚，项目图标按自己的 key 解", () => {
    render(
      <RowSecondaryLine
        axis="time"
        agent={agent}
        project={{ ...project, icon: "rocket" }}
    ...
    expect(
      screen
        .getByTestId("row-secondary-line")
        .querySelector("[data-kind='project-avatar'] svg")
        ?.getAttribute("class"),
    ).toContain("lucide-rocket");
  });
});
