...
import { statusConfig, type AgentStatus } from "../../agent-status";
...
// AgentSpawnCard remains the single production renderer. Single-run data (no runs
// array) keeps the flat layout; normalized parallel/chain state branches into
// grouped runs.
export const AgentSpawnCard: React.FC<CanonicalCardProps> = ({
  ...
  // Flat single-run and normalized single both attach every child, including
  // missing or unknown run IDs, to their sole STEPS list.
