...
const LANDINGS: Record<EventKind, Landing> = {
  ...
  [EventToolApprovalRequested]: { kind: "block", blockType: "tool_approval" },
  ...
  [EventUnsupportedRequestNotice]: { kind: "block", blockType: "notice" },
  [EventImage]: { kind: "block", blockType: "image" },
  ...
  [EventToolApprovalResolved]: { kind: "backfill" },
...
const PAYLOADS: Partial<Record<EventKind, Record<string, unknown>>> = {
  ...
  [EventUnsupportedRequestNotice]: { purpose: "sudo_password" },
  [EventImage]: { mediaType: "image/png", source: { inline: "AQID" } },
