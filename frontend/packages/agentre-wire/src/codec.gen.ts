 ...
 * 不带这些字段的老客户端拿到的形态。
 */
export interface SessionListParams extends WireObject {
...
export function decodeSessionListParams(v: unknown): SessionListParams {
  return decodeWire<SessionListParams>(v, "SessionListParams", (o) => {
    o.keyword = optStr(o.keyword, "SessionListParams.keyword");
    o.cursor = optStr(o.cursor, "SessionListParams.cursor");
    o.limit = optNum(o.limit, "SessionListParams.limit");
    o.conversationIds = optArr(
      o.conversationIds,
      "SessionListParams.conversationIds",
    );
  });
}

export function encodeSessionListParams(v: SessionListParams): string {
  return encodeWire(v);
}
...
export function decodeSessionListResult(v: unknown): SessionListResult {
  return decodeWire<SessionListResult>(v, "SessionListResult", (o) => {
    ...
    o.cursor = optStr(o.cursor, "SessionListResult.cursor");
    o.hasMore = optBool(o.hasMore, "SessionListResult.hasMore");
    o.total = optNum(o.total, "SessionListResult.total");
  });
}
 ...
 */
export interface SessionCountsResult extends WireObject {
  total: number;
  running: number;
  waiting: number;
}

export function decodeSessionCountsResult(v: unknown): SessionCountsResult {
  return decodeWire<SessionCountsResult>(v, "SessionCountsResult", (o) => {
    o.total = reqNum(o.total, "SessionCountsResult.total");
    o.running = reqNum(o.running, "SessionCountsResult.running");
    o.waiting = reqNum(o.waiting, "SessionCountsResult.waiting");
  });
}

export function encodeSessionCountsResult(v: SessionCountsResult): string {
  return encodeWire(v);
}
 ...
 */
export interface TurnStartedFrame extends WireObject {
  conversationId: string;
  seq?: number;
}

export function decodeTurnStartedFrame(v: unknown): TurnStartedFrame {
  return decodeWire<TurnStartedFrame>(v, "TurnStartedFrame", (o) => {
    o.conversationId = reqStr(
      o.conversationId,
      "TurnStartedFrame.conversationId",
    );
    o.seq = optNum(o.seq, "TurnStartedFrame.seq");
  });
}

export function encodeTurnStartedFrame(v: TurnStartedFrame): string {
  return encodeWire(v);
}
